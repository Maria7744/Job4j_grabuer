...
//Этот компонент позволяет собрать короткое описание всех объявлений, а
// так же загрузить детали по каждому объявлению.
//
...
//
//Например, осуществить сбор данных с
// других площадок: SqlRuParse, HhRuParse, SuperJobParse.
//
//
